...
options = '--export-3mf --repair --output %s %s --merge %s'
...
plates = [
    ...
    dict(
        ...
        output = "Plate/extruder_phaetus_dragon.3mf"
    ),
    dict(
        source = [
        ...
        output = "Plate/extruder_revo_voron.3mf"
    ),
    dict(
        source = [
        ...
        output = "Plate/extruder_[a].3mf"
    ),
    dict(
        source = ['STLs/Extruder/[c]_*.stl'],
        output = "Plate/extruder_[c].3mf"
    ),
    dict(
        source = ['STLs/Extruder/[o]_*.stl'],
        output = "Plate/extruder_[o].3mf"
    ),
    ...
    dict(
        ...
        output = "Plate/gantry_[a].3mf"
    ),
    dict(
        source = [
            'STLs/Gantry/a_drive_frame_{lower,upper}.stl',
        ],
        output = "Plate/gantry_a_drive.3mf"
    ),
    dict(
        source = [
            'STLs/Gantry/b_drive_frame_{lower,upper}.stl',
        ],
        output = "Plate/gantry_b_drive.3mf"
    ),
    dict(
        source = [
            'STLs/Gantry/front_idler_{left,right}_{lower,upper}.stl',
        ],
        output = "Plate/gantry_idlers.3mf"
    ),
    dict(
        source = [
        ...
        output = "Plate/gantry_tap.3mf"
    ),
    dict(
        source = [
            'STLs/Gantry/xy_joint_{left,right}_{lower,upper}_MGN12.stl',
        ],
        output = "Plate/gantry_xy_joints.3mf"
    ),
    dict(
        source = [
    ...
    dict(
        ...
        output = "Plate/panels_bottom.3mf"
    ),
    dict(
        source = [
    ...
    dict(
        ...
        output = "Plate/panels_door.3mf"
    ),
    dict(
        source = [
            'STLs/Panels/exhaust_filter_{grill,housing}.stl',
        ],
        output = "Plate/exhaust.3mf"
    ),
    ...
    dict(
        ...
        output = "Plate/electronics.3mf"
    ),
    dict(
        source = ['STLs/Nevermore/V2_Duo_Plenum*.stl'],
        output = "Plate/nevermore_plenum.3mf"
    ),
    dict(
        source = ['STLs/Nevermore/XL_Cartridge*.3mf'],
        output = "Plate/nevermore_xl_cartridge.3mf"
    ),
    dict(
        source = ['STLs/Tools/*.stl', 'STLs/Tools/**/*.stl'],
        output = "Plate/tools.3mf"
    ),
]
